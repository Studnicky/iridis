...
- **Role-resolved.** Pick `iridis-4`, `iridis-8`, `iridis-12`, or the full `iridis-16` schema. Or write your own role schema in the right panel. Each tier nests inside the next, so picking a smaller tier paints with fewer tokens.
