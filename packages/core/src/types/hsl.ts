import type { HslResultInterfaceTypeEntity } from '../entities/HslResultInterfaceTypeEntity.ts';
...
export type HslResultInterfaceType = HslResultInterfaceTypeEntity.Type;
