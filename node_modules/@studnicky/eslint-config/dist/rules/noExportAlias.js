...
export const noExportAlias = {
    'create': (context) => {
        const filename = context.filename;
        const inIndex = isIndexFile(filename);
        const importedBindings = new Set();
        const onImportDeclaration = (node) => {
            const rawNode = node;
        ...
        const onExportNamedDeclaration = (node) => {
            const rawNode = node;
            if (!inIndex) {
        ...
        const onExportAllDeclaration = (node) => {
            if (inIndex) {
                return;
            }
            context.report({
    ...
    'meta': {
        ...
        'messages': {
            ...
            'exportImportedBindingOutsideIndex': 'Exporting an imported binding is only permitted in index files. Import and use the symbol directly instead of forwarding it.',
...
//# sourceMappingURL=noExportAlias.js.map