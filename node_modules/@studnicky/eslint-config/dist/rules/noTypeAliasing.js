...
class AstHelpers {
    ...
    static getTypeArgNames(typeArguments) {
    ...
    static getTypeParamNames(typeParameters) {
...
const isGenericForwardingShim = (leftNames, annotation) => {
...
export const noTypeAliasing = {
    'create': (context) => {
        const onTSTypeAliasDeclaration = (node) => {
            const rawNode = node;
...
//# sourceMappingURL=noTypeAliasing.js.map