 ...
 */
import { BUFFER_GROWTH_FACTOR, DEFAULT_BUFFER_CAPACITY, EMPTY_LENGTH, FIRST_ARRAY_INDEX, INCREMENT_BY_ONE, INITIAL_BUFFER_COUNT, INITIAL_BUFFER_HEAD, INITIAL_BUFFER_TAIL } from '../constants/index.js';
...
export class CircularBuffer {
     ...
     */
    static builder() {
        const result = CircularBufferBuilder.create((options) => {
            const buffer = CircularBuffer.create(options);
            return buffer;
        });
        return result;
    }
    ...
    constructor(options = {}) {
        ...
        this._items = Array.from({ 'length': capacity });
    ...
    grow() {
        ...
        const newItems = Array.from({ 'length': newCapacity });
     ...
     */
    onGrow(_oldCapacity, _newCapacity) {
        // no-op
    }
    /**
