...
export interface FetchClientInterface {
    ...
    patch(path: string, options?: Omit<FetchOptionsType, 'body'> & {
        'body'?: unknown;
    }): Promise<Response>;
    post(path: string, options?: Omit<FetchOptionsType, 'body'> & {
        'body'?: unknown;
    }): Promise<Response>;
    put(path: string, options?: Omit<FetchOptionsType, 'body'> & {
        'body'?: unknown;
    }): Promise<Response>;
    request(path: string): RequestBuilderInterface;
}
//# sourceMappingURL=FetchClientInterface.d.ts.map