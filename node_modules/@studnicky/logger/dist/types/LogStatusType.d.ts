 ...
 * ```
 */
export type LogStatusType = 'cached' | 'complete' | 'failed' | 'in_progress' | 'invalid' | 'not_found' | 'partial' | 'pending' | 'rate_limited' | 'retry_exhausted' | 'retrying' | 'skipped' | 'success' | 'timeout' | 'unauthorized' | 'unavailable';
/**
...
//# sourceMappingURL=LogStatusType.d.ts.map