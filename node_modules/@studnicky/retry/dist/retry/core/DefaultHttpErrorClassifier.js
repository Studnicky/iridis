import { EARLY_RETRY_THRESHOLD, HTTP_REQUEST_TIMEOUT, HTTP_TOO_MANY_REQUESTS } from '../../constants/index.js';
 ...
 * ```
 */
export class DefaultHttpErrorClassifier extends ErrorClassifier {
    static create() {
     ...
     * ```
     */
    classify(error, attemptNumber) {
        const { HTTP_MATCHERS, NETWORK_MATCHERS } = ErrorClassifier;
...
//# sourceMappingURL=DefaultHttpErrorClassifier.js.map