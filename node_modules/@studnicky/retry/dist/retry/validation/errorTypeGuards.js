 ...
 */
function isErrorOrObjectLike(value) {
...
function isErrorWithStatus(error) {
    return (isErrorOrObjectLike(error)
        && 'status' in error
 ...
 * ```
 */
function isErrorWithRetryAfter(error) {
    return (isErrorOrObjectLike(error)
        && 'retryAfter' in error
 ...
 * ```
 */
function isErrorWithErrno(error) {
    return (isErrorOrObjectLike(error)
        && 'errno' in error
 ...
 * ```
 */
function isErrorWithSyscall(error) {
    return (isErrorOrObjectLike(error)
        && 'syscall' in error
 ...
 * ```
 */
function isErrorWithHostname(error) {
    return (isErrorOrObjectLike(error)
        && 'hostname' in error
 ...
 * ```
 */
function isErrorWithPort(error) {
    return (isErrorOrObjectLike(error)
        && 'port' in error
 ...
 * ```
 */
function isErrorWithAddress(error) {
    return (isErrorOrObjectLike(error)
        && 'address' in error
