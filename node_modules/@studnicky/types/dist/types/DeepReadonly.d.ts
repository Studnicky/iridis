 ...
 */
export type DeepReadonlyType<T> = T extends (infer U)[] ? readonly DeepReadonlyType<U>[] : T extends readonly (infer U)[] ? readonly DeepReadonlyType<U>[] : T extends Set<infer U> ? ReadonlySet<DeepReadonlyType<U>> : T extends Map<infer K, infer V> ? ReadonlyMap<DeepReadonlyType<K>, DeepReadonlyType<V>> : T extends object ? {
