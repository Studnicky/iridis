...
export class GpuDetector {
    ...
    static #detectMetal() {
        try {
            ...
            const vramMb = GpuDetector.#parseVramString(typeof first.spdisplays_vram === 'string' ? first.spdisplays_vram : null);
    ...
    static #detectNvidia() {
        try {
            const raw = execFileSync('nvidia-smi', ['--query-gpu=name,memory.total', '--format=csv,noheader,nounits'], { 'timeout': EXEC_TIMEOUT_MS }).toString().trim();
    ...
    static #parseVramString(vramStr) {
        if (vramStr === null) {
            return null;
        }
