...
export class VirtualScheduler {
    ...
    onAdvance(_deltaMs) { return; }
    /** Called at the start of `runUntil()`. */
    onRunUntil(_atMs) { return; }
    /**
    ...
    scheduleAt(atMs, fire) {
        ...
        return new VirtualTask(atMs, id, (taskId) => {
...
//# sourceMappingURL=VirtualScheduler.js.map