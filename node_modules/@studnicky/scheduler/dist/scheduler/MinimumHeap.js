...
export class MinimumHeap {
    ...
    #bubbleUp(index) {
        ...
        while (current > 0) {
            ...
            if (parent === undefined || child === undefined || parent.atMs <= child.atMs) {
                break;
            }
    ...
    #siftDown(index) {
        ...
        for (;;) {
            ...
            if (left < heapLength && leftTask !== undefined && smallestTask !== undefined && leftTask.atMs < smallestTask.atMs) {
                smallest = left;
            }
            const rightTask = this.#heap[right];
            const candidateTask = this.#heap[smallest];
            if (right < heapLength && rightTask !== undefined && candidateTask !== undefined && rightTask.atMs < candidateTask.atMs) {
                smallest = right;
            }
            if (smallest === current) {
                break;
            ...
            if (temporary === undefined || swapTarget === undefined) {
                break;
            }
