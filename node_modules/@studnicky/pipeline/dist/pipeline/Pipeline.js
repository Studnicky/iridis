...
export class Pipeline {
     ...
     */
    static builder() {
        const result = PipelineBuilder.create(() => { const instance = Pipeline.create(); return instance; });
        return result;
    }
    /**
