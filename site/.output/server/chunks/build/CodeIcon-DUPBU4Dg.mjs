...
import { B as useAppConfig, G as _sfc_main$f } from './server.mjs';
import 'node:http';
import 'node:https';
import 'node:events';
import 'node:buffer';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      if (icon.value) {
        _push(ssrRenderComponent(_sfc_main$f, mergeProps({ name: icon.value }, _attrs), null, _parent));
      } else {
        _push(`<!---->`);
      }
    };
...
//# sourceMappingURL=CodeIcon-DUPBU4Dg.mjs.map
