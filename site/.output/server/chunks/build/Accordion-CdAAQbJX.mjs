import { useSlots, computed, ref, mergeProps, unref, withCtx, createVNode, resolveDynamicComponent, openBlock, createBlock, renderSlot, createCommentVNode, createTextVNode, toDisplayString, Fragment, renderList, useSSRContext } from 'vue';
...
import { z as useComponentProps, B as useAppConfig, C as tv, ae as transformUI, D as useForwardProps, N as get, G as _sfc_main$f } from './server.mjs';
                            ...
                            default: withCtx((_3, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
                                ...
                                if (unref(get)(item, unref(props).labelKey) || !!slots.default) {
                                  _push5(`<span data-slot="label" class="${ssrRenderClass(ui.value.label({ class: [unref(props).ui?.label, item.ui?.label] }))}"${_scopeId4}>`);
                        ...
                        default: withCtx((_2, _push4, _parent4, _scopeId3) => {
                          if (_push4) {
                            ssrRenderSlot(_ctx.$slots, item.slot || "content", {
                              ...
                              _push4(`<div data-slot="body" class="${ssrRenderClass(ui.value.body({ class: [unref(props).ui?.body, item.ui?.body] }))}"${_scopeId3}>`);
...
//# sourceMappingURL=Accordion-CdAAQbJX.mjs.map
