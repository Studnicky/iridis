...
import { z as useComponentProps, B as useAppConfig, I as useFieldGroup, J as useComponentIcons, C as tv, P as Primitive, G as _sfc_main$1, L as _sfc_main$2 } from "../server.mjs";
const theme = {
  "slots": {
            ...
            return [
              renderSlot(_ctx.$slots, "leading", { ui: ui.value }, () => [
                unref(isLeading) && unref(leadingIconName) ? (openBlock(), createBlock(_sfc_main$1, {
                  ...
                  "data-slot": "leadingIcon",
                  class: ui.value.leadingIcon({ class: unref(props).ui?.leadingIcon })
                }, null, 8, ["name", "class"])) : !!unref(props).avatar ? (openBlock(), createBlock(_sfc_main$2, mergeProps({
                  key: 1,
                  size: unref(props).ui?.leadingAvatarSize || ui.value.leadingAvatarSize()
                }, unref(props).avatar, {
                  "data-slot": "leadingAvatar",
...
//# sourceMappingURL=Badge-BckZTFui.js.map
