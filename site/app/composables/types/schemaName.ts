 ...
 *  set. */
export declare namespace SchemaNameType {
  type Type = 'iridis-4' | 'iridis-8' | 'iridis-12' | 'iridis-16' | 'iridis-32';
}

/** The schema tier every palette pipeline falls back to when `schemaName` doesn't resolve a registered entry. */
export const DEFAULT_SCHEMA_NAME: SchemaNameType.Type = 'iridis-32';
