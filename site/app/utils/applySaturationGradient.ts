...
class ApplySaturationGradientOperation {
  static run(hues: number[], count = 5): HueSaturationType[] {
...
export const applySaturationGradient = ApplySaturationGradientOperation.run;
