...
class ApplyTintsShadesVariationOperation {
  static run(hues: number[], count = 5): HueLightnessType[] {
...
export const applyTintsShadesVariation = ApplyTintsShadesVariationOperation.run;
