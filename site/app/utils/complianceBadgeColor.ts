...
class ComplianceBadgeColorOperation {
  static run(compliance: string): 'success' | 'primary' | 'neutral' {
...
export const complianceBadgeColor = ComplianceBadgeColorOperation.run;
